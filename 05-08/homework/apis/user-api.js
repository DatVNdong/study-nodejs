...
exports.load = function (app) {
    ...
    app.get(`${userRoute}/:id`, validate(userValidation.findOneSchema()), userController.findOne); // find one user by id
    app.put(`${userRoute}/:id`, validate(userValidation.updateSchema()), userController.update); // update one user by id
    app.delete(`${userRoute}/:id`, validate(userValidation.findOneSchema()), userController.remove); // delete one user by id
};
